...
import jp.pizzafactory.modeling.dsl.vstepngt.ngtext.web.LanguageWebSetup;
...
public class LanguageServlet extends XtextServlet {
  ...
  public void init() {
    try {
      ...
      LanguageWebSetup _languageWebSetup = new LanguageWebSetup(executorServiceProvider);
      _languageWebSetup.createInjectorAndDoEMFRegistration();
    } catch (Throwable _e) {
